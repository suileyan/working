<template>
  <div class="file-upload-container">
    <el-upload ref="uploadRef" class="upload-demo" :drag="drag" :action="action" :accept="accept" :disabled="disabled"
      :auto-upload="false" :show-file-list="true" :before-upload="handleBeforeUpload" :on-change="handleChange"
...
import type { UploadUserFile, UploadFile, ElUpload } from 'element-plus'
...
const handleChange = (uploadFile: UploadFile, uploadFiles: UploadUserFile[]) => {
  fileList.value = uploadFiles
  emit('change', uploadFiles)
}

const handleRemove = (uploadFile: UploadFile, uploadFiles: UploadUserFile[]) => {
  fileList.value = uploadFiles
  emit('change', uploadFiles)
}
